...
#draw main menu
 def Menus.drawmainmenu(meth_window)
  meth_window.clear(SF::Color::Black); meth_window.draw(@@text_title); meth_window.draw(@@rectangle_menu); 
  meth_window.draw(@@rectangle_opt1); meth_window.draw(@@text_opt1); meth_window.draw(@@rectangle_opt2); 
  meth_window.draw(@@text_opt2); meth_window.draw(Cursor_opt1); meth_window.display
  end
